...
** NF erkennen
Gib bei den den folgenden Tabellen an ob sie in /keiner/, der /1NF/, /2NF/ oder der /3NF/ sind. 
...
Gibt es mehr als die 3NF? Falls ja bennene sie und gib eine kurze Erklärung dazu.

* Merkhilfe für die Normalformen
1. Normalform (1NF) Alle Attribute sind atomar.
2. Normalform (2NF) Die Relation befindet sich in 1NF und alle Nichtschlüsselattribute sind voll funktional abhängig vom Primärschlussel.
